                            ...
                            <div class="tab-pane fade <?php if ($lang['base']) echo 'active show' ?>" id="<?= $k ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="page_description[<?= $lang['id'] ?>][title]"
                                           ...
                                           value="<?= isset($page[$lang['id']]['title']) ? htmlspecialchars($page[$lang['id']]['title']) : '' ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="page_description[<?= $lang['id'] ?>][description]"
                                           ...
                                           value="<?= isset($page[$lang['id']]['description']) ? htmlspecialchars($page[$lang['id']]['description']) : '' ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="page_description[<?= $lang['id'] ?>][keywords]"
                                           ...
                                           value="<?= isset($page[$lang['id']]['keywords']) ? htmlspecialchars($page[$lang['id']]['keywords']) : '' ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="page_description[<?= $lang['id'] ?>][content]"
                                              ...
                                              placeholder="Контент страницы"><?= isset($page[$lang['id']]['content']) ? htmlspecialchars($page[$lang['id']]['content']) : '' ?></textarea>
                                </div>
