                            ...
                            <div class="tab-pane fade <?php if ($lang['base']) echo 'active show' ?>" id="<?= $k ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_description[<?= $lang['id'] ?>][title]"
                                           ...
                                           value="<?= htmlspecialchars($product[$lang['id']]['title']) ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_description[<?= $lang['id'] ?>][description]"
                                           ...
                                           value="<?= isset($product[$lang['id']]['description']) ? htmlspecialchars($product[$lang['id']]['description']) : '' ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_description[<?= $lang['id'] ?>][keywords]"
                                           ...
                                           value="<?= isset($product[$lang['id']]['keywords']) ? htmlspecialchars($product[$lang['id']]['keywords']) : '' ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_description[<?= $lang['id'] ?>][excerpt]"
                                           ...
                                           value="<?= htmlspecialchars($product[$lang['id']]['excerpt']) ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="product_description[<?= $lang['id'] ?>][content]"
                                              ...
                                              placeholder="Описание товара"><?= htmlspecialchars($product[$lang['id']]['content']) ?></textarea>
                                </div>
